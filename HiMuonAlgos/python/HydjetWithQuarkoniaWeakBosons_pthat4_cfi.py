# example cmsDriver.py CmsHi/HiMuonAlgos/HydjetWithQuarkoniaWeakBosons_pthat4_cfi -s GEN,SIM,DIGI,L1,DIGI2RAW -n 5 --geometry DB --conditions auto:mc --datatier 'GEN-SIM-RAW' --eventcontent RAWDEBUG --scenario HeavyIons --no_exec
