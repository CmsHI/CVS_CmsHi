...
process = cms.Process("ZMuMuFilter")
...
#from my_code.ZToMuMu.RD_NZS_enriched_cfi import *
process.source = cms.Source("PoolSource",
 ...
 'rfio:/castor/cern.ch/user/h/hckim/JulyExercise10/JulyExercise10_MinimumBiasHI_dilepton_skim0/JulyExercise10_MinimumBiasHI_dilepton_skim0_95_1_E2H.root'#'file:/afs/cern.ch/user/s/silvest/public/html/JulyExercise/ZMuMuSkim_fireworks_filtering.root'
...
process.output = cms.OutputModule("PoolOutputModule",
 ...
 SelectEvents=cms.untracked.PSet(
                                   SelectEvents=cms.vstring('DiMuonsSTAMassCut_Step')
                                   #SelectEvents=cms.vstring('DiMuonsGlobalHighQuality_Step') 	
                                   ))
                                  
process.outpath = cms.EndPath(process.output)
# If generator level information is avilable uncomment this
process.schedule=cms.Schedule(process.DiMuonsSTAMassCut_Step,process.outpath)
