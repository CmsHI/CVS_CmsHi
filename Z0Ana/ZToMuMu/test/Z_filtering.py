...
# 'file:/afs/cern.ch/user/s/silvest/public/html/JulyExercise/ZMuMuSkim_fireworks_filtering.root'
 '/store/user/kimy/MinimumBiasHI/Spring10-JulyAnalysisExercise_MC_37Y_V4-HardEnriched-v3-RECO-prelim-v1/599
a3a4efd1a163b86e329cbf44e9f6a/hiRecoJEX_RAW2DIGI_RECO_99_1_UFG.root'
    )# fileNames = cms.untracked.vstring(
...
process.DiMuonsGlobalHightQuality = cms.Path(process.DimuonsMassCut*process.dimuonsGlobalHightQuality*process.dimuonsGlobalFilter)
...
process.output = cms.OutputModule("PoolOutputModule",
                                  ...
                                  #process.muonSkimContent,
                                    fileName = cms.untracked.string('Z_filtering.root'),
 ...
 SelectEvents=cms.untracked.PSet(
                                   ...
                                   #SelectEvents=cms.vstring('DiMuonsGlobalHightQuality')
                                   )
...
#process.schedule=cms.Schedule(process.DiMuonsGlobalHightQuality,process.outpath)
