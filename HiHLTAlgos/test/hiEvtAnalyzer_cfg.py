...
#process.p = cms.Path(process.siPixelRecHits * process.pACentrality * process.hiEvtAnalyzer)
...
process.p = cms.Path(process.PAcollisionEventSelection * process.siPixelRecHits * process.pACentrality * process.hiEvtAnalyzer)
