...
//TCut evtSel("Run==152791&&hiBin<40"); // Another Run Possibility. 
  ...
  tree->Draw("LumiBlock>>hLumi1", evtSel,"goff");
  ...
  hLumi1->SetAxisRange(1,500,"Y");

  //Draw histograms
  TCanvas * c4 = new TCanvas("c4", "Event Rate for Lumi Section", 700, 650);
  c4->SetLogy();
  ...
  //Create Lengend
  TLegend *t = new TLegend(0.571839,0.751261,0.91954,0.921008);
