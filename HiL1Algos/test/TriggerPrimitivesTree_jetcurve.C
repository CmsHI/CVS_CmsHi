				      ...
				      enum SUBTRACT_ALGORITHM algorithm)
{
  ...
  stringstream name;
  name << "Jet Turn-On Curve, threshold:" << threshold << " compressed Et";
  TH1D* jet_curve = new TH1D("jet_curve", name.str().c_str(),
			     nbins,0,100);
  TH1I* total_in_bin = new TH1I("total_in_bin","total_in_bin",
				nbins,0,100);
  ...
  jet_curve->SetXTitle("Real Jet Pt");
