...
TFile *f1 = new TFile("turnonmb_after_wselection.root");
hmb = (TH2*)f1->Get("JetEt");
TFile *f2 = new TFile("turnonjet_after_wselection.root");
hjet = (TH2*)f2->Get("JetEt");
TFile *f3 = new TFile("turnoncent_after_wselection.root");
hcent = (TH2*)f3->Get("JetEt");
TFile *f4 = new TFile("turnonpp_after_wselection.root");
hpp = (TH2*)f4->Get("JetEt");
// TFile *f5 = new TFile("turnonmb_after.root");
TFile *f5 = new TFile("turnonmb_before_wselection.root");
hmbb = (TH2*)f5->Get("JetEt");
TFile *f6 = new TFile("turnonjet_before_wselection.root");
hjetb = (TH2*)f6->Get("JetEt");
TFile *f7 = new TFile("turnoncent_before_wselection.root");
hcentb = (TH2*)f7->Get("JetEt");
TFile *f8 = new TFile("turnonpp_before_wselection.root");
...
TLatex* t9=new TLatex(300,0.2,"N_{event}=214549");
t1->SetTextSize(0.05);
t9->SetTextSize(0.05);
t1->Draw();
t9->Draw();
...
TLatex* t10=new TLatex(350,0.2,"N_{event}=2530");
t2->SetTextSize(0.05);
...
TLatex* t11=new TLatex(350,0.2,"N_{event}=2996");
t3->SetTextSize(0.05);
...
TLatex* t12=new TLatex(350,0.2,"N_{event}=3342");
t4->SetTextSize(0.05);
...
p5->SetTitle("Turn On Curve For Minimum Bias Data Before Subtraction");
...
p5->GetXaxis()->SetLimits(0,350);
p5->Draw();
TLatex* t5=new TLatex(250,0.1,"E_{thr}=295");
// TLatex* t5=new TLatex(350,0.1,"E_{thr}=63.5");
TLatex* t13=new TLatex(200,0.2,"N_{event}=214549");
t5->SetTextSize(0.05);
t13->SetTextSize(0.05);
t5->Draw();
t13->Draw();
c1->SaveAs("turnonMB_before.png");
c1->SaveAs("turnonMB_before.gif");


// c1->cd(6);
TProfile* p6=hjetb->ProfileX("p6",0,99);
p6->SetTitle("Turn On Curve For Jet Data Before Subtraction");
...
p6->GetXaxis()->SetLimits(0,350);
p6->Draw();
TLatex* t6=new TLatex(250,0.1,"E_{thr}=295");
// TLatex* t6=new TLatex(350,0.1,"E_{thr}=63.5");
TLatex* t14=new TLatex(250,0.2,"N_{event}=2530");
t6->SetTextSize(0.05);
t14->SetTextSize(0.05);
t6->Draw();
t14->Draw();
c1->SaveAs("turnonjet_before.png");
c1->SaveAs("turnonjet_before.gif");


// c1->cd(7);
TProfile* p7=hcentb->ProfileX("p7",0,99);
p7->SetTitle("Turn On Curve For Central Data Before Subtraction");
...
p7->GetXaxis()->SetLimits(0,350);
p7->Draw();
TLatex* t7=new TLatex(250,0.1,"E_{thr}=295");
// TLatex* t7=new TLatex(350,0.1,"E_{thr}=63.5");
TLatex* t15=new TLatex(250,0.2,"N_{event}=2996");
t7->SetTextSize(0.05);
...
t8->Draw();
*/
c1->SaveAs("turnoncent_before.png");
c1->SaveAs("turnoncent_before.gif");
