...
// Wed Apr 11 10:30:18 2012 by ROOT version 5.27/06b
// from TTree HltTree/
...
HltTree::HltTree(TTree *tree)
{
  ...
  if (tree == 0) {
       ...
       // TFile *f = new TFile("/net/hidsk0001/d00/scratch/dgulhan/mergedforest/pp/HiForest_pp_v0.root");
       
       //file locations at CERN    
       // TFile *f = new TFile("/d102/richard/HiForestL1-centeral_merged_v0.root");
       // TFile *f = new TFile("/d102/richard/HiForestL1-jet_merged_v1.root");
       TFile *f = new TFile("/d102/richard/HiForestL1-minbias_merged_v2.root");
       // TFile *f = new TFile("/d102/richard/HiForest_pp_minbias_v0.root");
       
       tree = (TTree*)gDirectory->Get("hltanalysis/HltTree");
...
void HltTree::Init(TTree *tree)
{
  ...
  fChain->SetBranchAddress("HLT_HIL1CaloMonitor_v1", &HLT_HIL1CaloMonitor_v1, &b_HLT_HIL1CaloMonitor_v1);
  fChain->SetBranchAddress("HLT_HIL1CaloMonitor_v1_Prescl", &HLT_HIL1CaloMonitor_v1_Prescl, &b_HLT_HIL1CaloMonitor_v1_Prescl);
