...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:/mnt/hadoop/cms/store/user/velicanu/raw/pp/00C632B2-04EB-E011-BD0A-0018F3D095EC.root')
)
...
process.RECODEBUGoutput.outputCommands = ["keep *_*_*_*", "drop FEDRawDataCollection_*_*_*"]
...
# process.schedule = cms.Schedule(process.raw2digi_step,process.L1Reco_step,process.endjob_step,process.RECODEBUGoutput_step)
