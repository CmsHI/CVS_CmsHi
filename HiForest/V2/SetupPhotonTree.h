...
public :
   ...
   Int_t           nPhotons;
   Float_t         pt[80];   //[nPhotons]
   Float_t         energy[80];   //[nPhotons]
   Float_t         rawEnergy[80];   //[nPhotons]
   Float_t         eta[80];   //[nPhotons]
   Float_t         phi[80];   //[nPhotons]
   Float_t         r9[80];   //[nPhotons]
   Bool_t          isEB[80];   //[nPhotons]
   Bool_t          isEBGap[80];   //[nPhotons]
   Bool_t          isEEGap[80];   //[nPhotons]
   Bool_t          isEBEEGap[80];   //[nPhotons]
   Bool_t          isTransGap[80];   //[nPhotons]
   Float_t         preshowerEnergy[80];   //[nPhotons]
   Float_t         numOfPreshClusters[80];   //[nPhotons]
   Float_t         ESRatio[80];   //[nPhotons]
   Float_t         clustersSize[80];   //[nPhotons]
   Float_t         scSize[80];   //[nPhotons]
   Float_t         phiWidth[80];   //[nPhotons]
   Float_t         etaWidth[80];   //[nPhotons]
   Float_t         scEta[80];   //[nPhotons]
   Float_t         scPhi[80];   //[nPhotons]
   Float_t         sigmaEtaEta[80];   //[nPhotons]
   Float_t         sigmaIetaIeta[80];   //[nPhotons]
   Float_t         sigmaIphiIphi[80];   //[nPhotons]
   Float_t         sieie50[80];   //[nPhotons]
   Float_t         sieie45[80];   //[nPhotons]
   Float_t         sieie47[80];   //[nPhotons]
   Float_t         sieie42[80];   //[nPhotons]
   Float_t         sieie39[80];   //[nPhotons]
   Float_t         covPhiPhi[80];   //[nPhotons]
   Float_t         covEtaPhi[80];   //[nPhotons]
   Float_t         covEtaEta[80];   //[nPhotons]
   Float_t         r1x5[80];   //[nPhotons]
   Float_t         r2x5[80];   //[nPhotons]
   Float_t         e1x5[80];   //[nPhotons]
   Float_t         e2x5[80];   //[nPhotons]
   Float_t         eMax[80];   //[nPhotons]
   Float_t         e2nd[80];   //[nPhotons]
   Float_t         e2x2[80];   //[nPhotons]
   Float_t         e3x3[80];   //[nPhotons]
   Float_t         e3x2[80];   //[nPhotons]
   Float_t         e4x4[80];   //[nPhotons]
   Float_t         e5x5[80];   //[nPhotons]
   Float_t         e2overe8[80];   //[nPhotons]
   Float_t         eRight[80];   //[nPhotons]
   Float_t         eLeft[80];   //[nPhotons]
   Float_t         eTop[80];   //[nPhotons]
   Float_t         eBottom[80];   //[nPhotons]
   Float_t         e2x5Right[80];   //[nPhotons]
   Float_t         e2x5Left[80];   //[nPhotons]
   Float_t         e2x5Top[80];   //[nPhotons]
   Float_t         e2x5Bottom[80];   //[nPhotons]
   Float_t         seedTime[80];   //[nPhotons]
   Float_t         seedChi2[80];   //[nPhotons]
   Float_t         seedOutOfTimeChi2[80];   //[nPhotons]
   Float_t         seedRecoFlag[80];   //[nPhotons]
   Float_t         seedSeverity[80];   //[nPhotons]
   Float_t         swissCrx[80];   //[nPhotons]
   Float_t         hadronicOverEm[80];   //[nPhotons]
   Float_t         hadronicDepth1OverEm[80];   //[nPhotons]
   Float_t         hadronicDepth2OverEm[80];   //[nPhotons]
   Float_t         ecalRecHitSumEtConeDR04[80];   //[nPhotons]
   Float_t         hcalTowerSumEtConeDR04[80];   //[nPhotons]
   Float_t         hcalDepth1TowerSumEtConeDR04[80];   //[nPhotons]
   Float_t         hcalDepth2TowerSumEtConeDR04[80];   //[nPhotons]
   Float_t         trkSumPtHollowConeDR04[80];   //[nPhotons]
   Float_t         trkSumPtSolidConeDR04[80];   //[nPhotons]
   Float_t         ecalRecHitSumEtConeDR03[80];   //[nPhotons]
   Float_t         hcalTowerSumEtConeDR03[80];   //[nPhotons]
   Float_t         hcalDepth1TowerSumEtConeDR03[80];   //[nPhotons]
   Float_t         hcalDepth2TowerSumEtConeDR03[80];   //[nPhotons]
   Float_t         trkSumPtHollowConeDR03[80];   //[nPhotons]
   Float_t         trkSumPtSolidConeDR03[80];   //[nPhotons]
   Int_t           isEle[80];   //[nPhotons]
   Int_t           hasPixelSeed[80];   //[nPhotons]
   Float_t         detaEle[80];   //[nPhotons]
   Float_t         dphiEle[80];   //[nPhotons]
   Float_t         eleCharge[80];   //[nPhotons]
   Float_t         eleEoverP[80];   //[nPhotons]
   Float_t         c1[80];   //[nPhotons]
   Float_t         c2[80];   //[nPhotons]
   Float_t         c3[80];   //[nPhotons]
   Float_t         c4[80];   //[nPhotons]
   Float_t         c5[80];   //[nPhotons]
   Float_t         r1[80];   //[nPhotons]
   Float_t         r2[80];   //[nPhotons]
   Float_t         r3[80];   //[nPhotons]
   Float_t         r4[80];   //[nPhotons]
   Float_t         r5[80];   //[nPhotons]
   Float_t         t1[80];   //[nPhotons]
   Float_t         t2[80];   //[nPhotons]
   Float_t         t3[80];   //[nPhotons]
   Float_t         t4[80];   //[nPhotons]
   Float_t         t5[80];   //[nPhotons]
   Float_t         t1PtCut[80];   //[nPhotons]
   Float_t         t2PtCut[80];   //[nPhotons]
   Float_t         t3PtCut[80];   //[nPhotons]
   Float_t         t4PtCut[80];   //[nPhotons]
   Float_t         t5PtCut[80];   //[nPhotons]
   Float_t         cc1[80];   //[nPhotons]
   Float_t         cc2[80];   //[nPhotons]
   Float_t         cc3[80];   //[nPhotons]
   Float_t         cc4[80];   //[nPhotons]
   Float_t         cc4j[80];   //[nPhotons]
   Float_t         cc5[80];   //[nPhotons]
   Float_t         cc05[80];   //[nPhotons]
   Float_t         cr1[80];   //[nPhotons]
   Float_t         cr2[80];   //[nPhotons]
   Float_t         cr3[80];   //[nPhotons]
   Float_t         cr4[80];   //[nPhotons]
   Float_t         cr5[80];   //[nPhotons]
   Float_t         cr4j[80];   //[nPhotons]
   Float_t         ct1[80];   //[nPhotons]
   Float_t         ct2[80];   //[nPhotons]
   Float_t         ct3[80];   //[nPhotons]
   Float_t         ct4[80];   //[nPhotons]
   Float_t         ct5[80];   //[nPhotons]
   Float_t         ct1PtCut20[80];   //[nPhotons]
   Float_t         ct2PtCut20[80];   //[nPhotons]
   Float_t         ct3PtCut20[80];   //[nPhotons]
   Float_t         ct4PtCut20[80];   //[nPhotons]
   Float_t         ct5PtCut20[80];   //[nPhotons]
   Float_t         ct4j20[80];   //[nPhotons]
   Float_t         ct4j10[80];   //[nPhotons]
   Float_t         ct4j15[80];   //[nPhotons]
   Float_t         ct4j[80];   //[nPhotons]
   Float_t         dr11[80];   //[nPhotons]
   Float_t         dr21[80];   //[nPhotons]
   Float_t         dr31[80];   //[nPhotons]
   Float_t         dr41[80];   //[nPhotons]
   Float_t         dr12[80];   //[nPhotons]
   Float_t         dr22[80];   //[nPhotons]
   Float_t         dr32[80];   //[nPhotons]
   Float_t         dr42[80];   //[nPhotons]
   Float_t         dr13[80];   //[nPhotons]
   Float_t         dr23[80];   //[nPhotons]
   Float_t         dr33[80];   //[nPhotons]
   Float_t         dr43[80];   //[nPhotons]
   Float_t         dr14[80];   //[nPhotons]
   Float_t         dr24[80];   //[nPhotons]
   Float_t         dr34[80];   //[nPhotons]
   Float_t         dr44[80];   //[nPhotons]
   Float_t         t11[80];   //[nPhotons]
   Float_t         t21[80];   //[nPhotons]
   Float_t         t31[80];   //[nPhotons]
   Float_t         t41[80];   //[nPhotons]
   Float_t         t12[80];   //[nPhotons]
   Float_t         t22[80];   //[nPhotons]
   Float_t         t32[80];   //[nPhotons]
   Float_t         t42[80];   //[nPhotons]
   Float_t         t13[80];   //[nPhotons]
   Float_t         t23[80];   //[nPhotons]
   Float_t         t33[80];   //[nPhotons]
   Float_t         t43[80];   //[nPhotons]
   Float_t         t14[80];   //[nPhotons]
   Float_t         t24[80];   //[nPhotons]
   Float_t         t34[80];   //[nPhotons]
   Float_t         t44[80];   //[nPhotons]
   Int_t           isGenMatched[80];   //[nPhotons]
   Int_t           genMatchedCollId[80];   //[nPhotons]
   Float_t         genMatchedPt[80];   //[nPhotons]
   Float_t         genMatchedEta[80];   //[nPhotons]
   Float_t         genMatchedPhi[80];   //[nPhotons]
   Int_t           genMomId[80];   //[nPhotons]
   Int_t           genGrandMomId[80];   //[nPhotons]
   Int_t           genNSiblings[80];   //[nPhotons]
   Float_t         genCalIsoDR03[80];   //[nPhotons]
   Float_t         genCalIsoDR04[80];   //[nPhotons]
   Float_t         genTrkIsoDR03[80];   //[nPhotons]
   Float_t         genTrkIsoDR04[80];   //[nPhotons]
   Int_t           nGp;
   Float_t         simVtxX;
   Float_t         simVtxY;
   Float_t         simVtxZ;
...
void setupPhotonTree(TTree *t,Photons &tPhotons,bool doCheck = 1)
{
   ...
   if (doCheck) {
      if (t->GetMaximum("nPhotons")>130) { cout <<"FATAL ERROR: Arrary size of nPhotons too small!!!  "<<t->GetMaximum("nPhotons")<<endl; exit(0);
