...
void plotBalance(int cbin = 0,
		 ...
		 TString refname = "data_PbPb.root",
		 TString mixname = "mix.root",
		 bool useWeight = true,
...
void plotFigure(int iplot = 0){
  TString infname = "data.root";
  TString refname = "data_PbPb.root";
  TString mixname = "mix_hydjet.root";
		 ...
		 bool drawLeg)
{
  ...
  if(cbin==0) centHF = "bin>=24 && bin<27";
  if(cbin==1) centHF = "bin>=27 && bin<28";
  if(cbin==2) centHF = "bin>=28 && bin<29";
  if(cbin==3) centHF = "bin>=29 && bin<31";
  if(cbin==4) centHF = "bin>=31 && bin<33";
  if(cbin==5) centHF = "bin>=33";
  ...
  nt->SetAlias("trk1","trkMax1");
  nt->SetAlias("trk2","trkMax2");
  ntMix->SetAlias("trk1","trkMax1");
  ntMix->SetAlias("trk2","trkMax2");
