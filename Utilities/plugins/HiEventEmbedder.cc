// -*- C++ -*-
//
// Package:    HiEventEmbedder
// Class:      HiEventEmbedder
// 
/**\class HiEventEmbedder HiEventEmbedder.cc HeavyIonsAnalysis/HiEventEmbedder/src/HiEventEmbedder.cc
...
class HiEventEmbedder : public edm::EDProducer {
   public:
      explicit HiEventEmbedder(const edm::ParameterSet&);
      ~HiEventEmbedder();
...
//
HiEventEmbedder::HiEventEmbedder(const edm::ParameterSet& pset)
{
...
HiEventEmbedder::~HiEventEmbedder()
{
...
void
HiEventEmbedder::produce(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
...
void 
HiEventEmbedder::beginJob(const edm::EventSetup&)
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
HiEventEmbedder::endJob() {
}

bool HiEventEmbedder::verifyRegistry(std::string object, std::string subdet, InputTag &tag,std::string &label) {
