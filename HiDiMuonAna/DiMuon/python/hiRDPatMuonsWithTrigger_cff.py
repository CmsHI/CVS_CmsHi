...
##   
### ==== Make PAT Muons ====
import PhysicsTools.PatAlgos.producersHeavyIons.heavyIonMuons_cff
...
patMuonsWithoutTrigger = PhysicsTools.PatAlgos.producersLayer1.muonProducer_cfi.patMuons.clone(
    ...
    beamLineSrc = cms.InputTag("offlineBeamSpot"), # Heavy Ion BeamSpot
...
muonL1Info.matched = cms.InputTag("hltL1extraParticles")
...
patMuonsWithoutTriggerSequence = cms.Sequence(
#    muonL1Info             *
    patMuonsWithoutTrigger# *
#    patTriggerMatching
)
...
#def changeTriggerProcessName(process, triggerProcessName, oldProcessName="DATAMIX"):
...
def addMCinfo(process):
    ...
    #process.patMuonsWithoutTriggerSequence.replace(process.patMuonsWithoutTrigger, process.muonMatch + process.patMuonsWithoutTrigger)
