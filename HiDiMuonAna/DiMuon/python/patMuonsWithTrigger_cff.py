...
patMuonsWithoutTrigger = PhysicsTools.PatAlgos.producersLayer1.muonProducer_cfi.patMuons.clone(
    ...
    beamLineSrc = cms.InputTag("offlineBeamSpot"), # Heavy Ion BeamSpot hltOfflineBeamSpot
...
# in HI: muonL1Info.matched = cms.InputTag("hltL1extraParticles")
# default:    matched      = cms.InputTag("l1extraParticles"),
...
addL1UserData(patMuonsWithoutTrigger, "muonL1Info") # commented in HI
