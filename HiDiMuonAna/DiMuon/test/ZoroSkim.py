...
'rfio:/castor/cern.ch/user/j/jrobles/HIRun2010/DataMix/Z0Flat0to50/hiReco_20_Mixed_20_DIGI_9ED5D30F-E5F0-DF11-BEF7-0030486780A8.root'

##re reco

#'rfio:/castor/cern.ch/user/m/mironov/cmssw394/rereco/zorov3/root/minbias_iter012345_f76_v3.root'
#'rfio:/castor/cern.ch/user/m/mironov/cmssw394/rereco/zorov3/root/minbias_iter012345_f1_v3.root'

#'rfio:/castor/cern.ch/user/m/mironov/testVineet.root'




#'rfio:/castor/cern.ch/user/d/davidlw/SingleZmumu_FlatPt0to50_cfi_py_GEN_SIM_RECO_394_v2/step2_1_76.root'
...
process.SKIMStreamZMM = cms.OutputModule("PoolOutputModule",
        ...
        #),
                                         fileName = cms.untracked.string('/tmp/kumarv/ReReco_ZoroSkimMC.root'),
...
process.load("HiDiMuonAna.DiMuon.hiRDPatMuonsWithTrigger_cff")
...
from HiDiMuonAna.DiMuon.hiRDPatMuonsWithTrigger_cff import addMCinfo, changeRecoMuonInput, useL1MatchingWindowForSinglets, changeTriggerProcessName, switchOffAmbiguityResolution
changeTriggerProcessName(process, "DATAMIX")
#changeTriggerProcessName(process, "TEST")
...
##Does not help
##process.muonL1Info.matched = cms.InputTag("hltL1extraParticles")
