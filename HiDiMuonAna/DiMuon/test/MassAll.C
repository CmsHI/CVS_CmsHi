...
void MassAll(int isData=2, int nff = 1, int yieldInt = 1, int iSpec = 1)
{
  ...
  TFile *fil1 = new TFile("DiMuon.root");   

  //  TFile *fil1 = new TFile("ZMuMu_2DPlots_150590WC.root");   

  //  TFile *fil1 = new TFile("run_150431_ed_DiMu2DPlots.root");   
  ...
  if(iSpec == 1) TH2D *Z0Mass_1S = (TH2D*)fil1->Get("diMuonsGlobalSameChargeInvMassVsPt");
 ...
 ///////////////////////////////////////////////////////////////////////
  ...
  for (Int_t ih = 0; ih < Nptbin; ih++) {
    ...
    dimuonsGlobalSTAInvMassVsPt[ih]->Rebin(nrebin);
    ...
    dimuonsGlobalSTAInvMassVsPt[ih]->GetXaxis()->SetRangeUser(mlow,mhigh);
 ...
 ///////////////////////////////////////////////////////////////////////
  ...
  for (Int_t ih = 0; ih < Nptbin; ih++) {
    ...
    dimuonsSTAInvMassVsPt[ih]->Rebin(nrebin);
    ...
    dimuonsSTAInvMassVsPt[ih]->GetXaxis()->SetRangeUser(mlow,mhigh);
