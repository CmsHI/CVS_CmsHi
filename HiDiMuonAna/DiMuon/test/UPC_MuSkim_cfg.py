...
process.MuSkimContent,
    ...
    filterName = cms.untracked.string('')),
                                  fileName = cms.untracked.string('file:UPC_MuSkim.root'),
...
#process.schedule=cms.Schedule(process.UPCTrigger_Step,process.PatMuon_Step,process.outpath)
#process.schedule=cms.Schedule(process.UPCTrigger_Step,process.MuonSkim_Step,process.STAMuonSkim_Step,process.GlobalMuonSkim_Step,process.outpath)
