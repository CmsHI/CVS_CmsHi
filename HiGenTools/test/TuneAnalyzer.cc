// -*- C++ -*-
//
// Package:    TuneAnalyzer
// Class:      TuneAnalyzer
// 
/**\class TuneAnalyzer TuneAnalyzer.cc yetkin/TuneAnalyzer/src/TuneAnalyzer.cc
...
// $Id: TuneAnalyzer.cc,v 1.22 2010/02/11 00:12:06 wmtan Exp $
//
//
...
class TuneAnalyzer : public edm::EDAnalyzer {
   public:
      explicit TuneAnalyzer(const edm::ParameterSet&);
      ~TuneAnalyzer();
...
//
TuneAnalyzer::TuneAnalyzer(const edm::ParameterSet& iConfig)
{
...
void
TuneAnalyzer::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
...
void
TuneAnalyzer::beginRun(const edm::Run&, const edm::EventSetup& iSetup) 
{
   iSetup.getData(pdt);
}

void 
TuneAnalyzer::beginJob()
{
...
DEFINE_FWK_MODULE(TuneAnalyzer);
