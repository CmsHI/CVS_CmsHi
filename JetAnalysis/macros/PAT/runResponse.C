...
void runResponse(){
  ...
  TFile* infile = new TFile("./test1/pat_jets_120to170.root","read");
  TFile* outFile = new TFile("./test1/jra_120to170.root","recreate");
  runResponseForAlgo("ic5",infile,outFile);
  runResponseForAlgo("ic7",infile,outFile);
  runResponseForAlgo("akPu5",infile,outFile);
  runResponseForAlgo("akPu7",infile,outFile);
  runResponseForAlgo("ak5",infile,outFile);
  runResponseForAlgo("ak7",infile,outFile);
