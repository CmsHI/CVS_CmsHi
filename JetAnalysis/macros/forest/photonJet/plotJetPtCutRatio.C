...
)
{
   ...
   hTmp->SetYTitle("R_{Gamma jet}");
   hTmp->GetXaxis()->CenterTitle();
   hTmp->GetYaxis()->CenterTitle();
   hTmp->GetYaxis()->SetTitleOffset(1.4);
   hTmp->GetYaxis()->SetTitleSize(0.05);
   hTmp->SetAxisRange(0,1.5,"Y");
   hTmp->Draw();
   ...
   TLatex *cms = new TLatex(0.1,1.41,"CMS Preliminary");
   cms->SetTextFont(63);
   cms->SetTextSize(17);
   cms->Draw();
