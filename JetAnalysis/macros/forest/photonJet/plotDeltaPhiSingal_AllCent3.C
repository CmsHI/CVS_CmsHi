                                ...
                                )
{
   ...
   c1->Print(Form("./fig/12.13photonNorm/photon60v2_v12_mcv2yongsun_jet30_dphi_all_cent_subAll_Isol%d_photonNorm.gif",isolScheme));
   c1->Print(Form("./fig/12.13photonNorm/photon60v2_v12_mcv2yongsun_jet30_dphi_all_cent_subAll_Isol%d_photonNorm.pdf",isolScheme));   
