...
public:
   ...
   void Draw(TString title, float ymin=0, float ymax=0, TString lname1="data", TString lname2="ref", bool drawLeg = false, float lx1=0.4, float ly1=0.18, float lx2=0.87, float ly2=0.28) {
