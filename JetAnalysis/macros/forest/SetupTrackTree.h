...
class Tracks
{
  ...
  ~Tracks(){};
   ...
   Int_t           trkNHit[maxEntry];   //[nTrk]
   Int_t           trkNlayer[maxEntry];   //[nTrk]
   Int_t           trkNlayer3D[maxEntry];   //[nTrk]
   Float_t         trkEta[maxEntry];   //[nTrk]
   Float_t         trkPhi[maxEntry];   //[nTrk]
   Int_t           trkQual[maxEntry];   //[nTrk]
   Float_t         trkChi2[maxEntry];   //[nTrk]
   Float_t         trkChi2hit1D[maxEntry];   //[nTrk]
   Float_t         trkNdof[maxEntry];   //[nTrk]
   Float_t         trkDz[maxEntry];   //[nTrk]
   Float_t         trkDzError[maxEntry];   //[nTrk]
   Float_t         trkDzError1[maxEntry];   //[nTrk]
   Float_t         trkDzError2[maxEntry];   //[nTrk]
   Float_t         trkDxy[maxEntry];   //[nTrk]
   Float_t         trkDxyBS[maxEntry];   //[nTrk]
   Float_t         trkDxy1[maxEntry];   //[nTrk]
   Float_t         trkDxy2[maxEntry];   //[nTrk]
   Float_t         trkDxyError[maxEntry];   //[nTrk]
   Float_t         trkDxyErrorBS[maxEntry];   //[nTrk]
   Float_t         trkDxyError1[maxEntry];   //[nTrk]
   Float_t         trkDxyError2[maxEntry];   //[nTrk]
   Float_t         trkDz1[maxEntry];   //[nTrk]
   Float_t         trkDz2[maxEntry];   //[nTrk]
   Float_t         trkVx[maxEntry];   //[nTrk]
   Float_t         trkVy[maxEntry];   //[nTrk]
   Float_t         trkVz[maxEntry];   //[nTrk]
   Bool_t          trkFake[maxEntry];   //[nTrk]
   Float_t         trkAlgo[maxEntry];   //[nTrk]
