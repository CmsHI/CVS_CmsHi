                            ...
                            )
{
   ...
   c2->Print(Form("%s/Photonv7_v19_RB%.0fSubDPhi%dSS%d_gamma%.0fjet%.0f_Npart_Isol%d_drawChk%d.pdf",outdir.Data(),ajCut*100,subDPhiSide,subSShapeSide,photonMinPt,minJet,isolScheme,drawCheck));
}
