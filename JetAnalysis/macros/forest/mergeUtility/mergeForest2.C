...
void mergeForest2(){
   ...
   const char* fname = "/mnt/hadoop/cms/store/user/frankmalocal/forest/promptskim-hihighpt-hltjet80-pt90-v1/*.root";
   TString outfname="/net/hidsk0001/d00/scratch/frankma/tmp/promptskim-hihighpt-hltjet80-pt90-v1_part.root";
