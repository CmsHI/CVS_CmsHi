root -b -q analyzePhotonJet.C+'("/d102/velicanu/forest/merged/HiForestPhoton_v5.root","output-data-Photon-v5_v15.root",1.,0)'
...
#root -b -q analyzePhotonJet_gen.C+'("/d101/kimy/macro/hiPhotonAna2011/rootFiles/photon50_corrCentralityv12.root","output-hypho50v2gen_yongsun50k_v15_frac62.root",0.62,1)'
