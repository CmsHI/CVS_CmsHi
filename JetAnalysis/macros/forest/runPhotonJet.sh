root -b -q analyzePhotonJet.C+'("/d102/velicanu/forest/merged/HiForestPhoton_v7.root","output-data-Photon-v7_v19.root",1.,0)'
root -b -q analyzePhotonJet.C+'("/d102/velicanu/forest/merged/HiForestPhoton_v6.root","output-data-Photon-v6_v19.root",1.,0)'
