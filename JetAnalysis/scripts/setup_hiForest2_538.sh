...
cvs co -r HiForest_V02_16 -d       MitHig/PixelTrackletAnalyzer             UserCode/MitHig/PixelTrackletAnalyzer
...
cvs co -r pPbProd_v06              HeavyIonsAnalysis/Configuration
...
cvs co -r HiForest_V02_64 -d       CmsHi/JetAnalysis UserCode/CmsHi/JetAnalysis
