...
process.pat_step          = cms.Path( process.icPu5patSequence + process.akPu3PFpatSequence + process.akPu5PFpatSequence +
                                      process.makeHeavyIonPhotons + process.ak5extra + process.ak3extra)
