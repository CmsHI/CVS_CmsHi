...
process.singleJet80Filter = process.hltHighLevel.clone()
process.singleJet80Filter.HLTPaths = ["HLT_HIJet80_v1"]

process.singleJetPt115Filter = cms.EDFilter("EtMinCaloJetCountFilter",
    src = cms.InputTag("icPu5CaloJetsL2L3"),
    etMin = cms.double(115),
    minNumber = cms.uint32(1)
)
                                             
process.ic5CaloL2Relative.algorithm = cms.string('IC5Calo_2760GeV')
process.ic5CaloL3Absolute.algorithm = cms.string('IC5Calo_2760GeV')

process.superFilterSequence = cms.Sequence(process.singleJet80Filter*process.icPu5CaloJetsL2L3*process.singleJetPt115Filter)
