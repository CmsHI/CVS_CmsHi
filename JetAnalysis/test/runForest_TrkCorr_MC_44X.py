...
ivars.inputFiles = "file:/mnt/hadoop/cms/store/user/yenjie/Hydjet1.8/Z2/Dijet50/tracking_v1/set2_random70000_HydjetDrum_762.root"
ivars.outputFile = './forest_v21.root'
ivars.maxEvents = -1
...
process.mergedTrack.trackPtMin = 4.
process.mergedTrack.simTrackPtMin = 4.
...
process.icPu5JetAnalyzer.isMC = True
process.akPu3PFJetAnalyzer.isMC = True
process.jetAnalyzers = cms.Sequence(process.icPu5JetAnalyzer+process.akPu3PFJetAnalyzer)
...
process.HiGenParticleAna.ptMin = cms.untracked.double(4)
...
process.ana_step          = cms.Path( process.genpana +
                                      ...
                                      (process.cutsTPForFakPxl * process.cutsTPForEffPxl * (process.trackeff_seq)) +
                                      process.mergedTrack +
